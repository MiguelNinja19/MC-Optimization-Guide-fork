...
5. Make sure you have all of [these mods](/mods-n-stuff/1.7.10.md) installed
...
5. Make sure you have all of [these mods](/mods-n-stuff/1.7.10.md) installed (except Hodgepodge, as it's currently incompatible with Morph)
6. Set the game to run with [the recommended Java version](/java-n-stuff/java-things.md)
...
3. Replace all of [these mods](/mods-n-stuff/1.7.10-compat-mods.md) (if present)
...
8. Make sure you have all of [these mods](/mods-n-stuff/1.7.10.md) installed
