...
>
> This is a fork to do what the original creator (who i forked) didn't do yet or other things (i speak portuguese)
> 
...
| [b1.7.3](/mods-n-stuff/b1.7.3**.md.md)** |

###### *The marked guides are currently in WIP.
###### **That its from me/issues from the original repo/other things
...
## Mirrors
[Gitlab Mirror](https://gitlab.com/MiguelNinja19/MC-Optimization-Guide-fork)
